...
},{"./blackbook":42,"bootstrap":1,"jquery":14,"vue":40,"vue-resource":29}],42:[function(require,module,exports){
'use strict';

var getApiUrl = function getApiUrl(action, param) {
    if (param === void 0) {
        param = '';
    }
...
module.exports = {
    ...
    computed: {
        ...
        blacklistCount: function blacklistCount() {
            if (!this.loaded) {
                return;
            }
    ...
    methods: {
        hate: function hate(person) {
            person.hates += 1;

            this.postRequest('hate', person.id);
        },
        unhate: function unhate(person) {
            person.hates = 0;

            this.postRequest('unhate', person.id);
        },
        postRequest: function postRequest(action, param) {
